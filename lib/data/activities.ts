import type { AtividadeAgendada, AtividadeEducacional, ResumoCard } from "@/lib/domain/types"

/** Atividades programadas para hoje (dashboard e calendário). */
export const proximasAtividades: AtividadeAgendada[] = [
...
/** Catálogo de atividades educacionais oferecidas. */
export const atividadesEducacionais: AtividadeEducacional[] = [
  {
...
/** Cartões de resumo (KPIs) do topo do dashboard. */
export const resumoCards: ResumoCard[] = [
  { id: "alunos-ativos", titulo: "Alunos Ativos", valor: "24", detalhe: "+2 este mês", cor: "text-primary" },
  { id: "atividades-hoje", titulo: "Atividades Hoje", valor: "8", detalhe: "4 concluídas", cor: "text-secondary" },
  { id: "progresso-medio", titulo: "Progresso Médio", valor: "78%", detalhe: "+5% este mês", cor: "text-accent" },
  { id: "proximas-reunioes", titulo: "Próximas Reuniões", valor: "3", detalhe: "Esta semana", cor: "text-foreground" },
]
