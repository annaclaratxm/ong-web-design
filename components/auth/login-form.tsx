...
/**
 * Formulário de login completo. Reúne em um único componente o que antes
 * estava duplicado entre `app/page.tsx` e `app/login/page.tsx`, agora ligado
 * ao contexto de autenticação com validação real e mensagem de erro.
 */
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4" noValidate>
              ...
              <div className="flex items-center justify-between">
                ...
                <Button variant="link" className="px-0 text-sm text-primary hover:text-primary/80" type="button">
                  Esqueci minha senha
                </Button>
              </div>
