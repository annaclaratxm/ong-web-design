...
/**
 * Cabeçalho do app autenticado: marca + ações (notificações, configurações,
 * sair). O logout agora passa pelo contexto de autenticação e usa o router,
 * em vez de manipular `localStorage` e estado diretamente no componente.
 */
